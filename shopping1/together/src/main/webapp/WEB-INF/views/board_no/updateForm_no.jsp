		...
		<div class="container" align="center">
			...
			<form action="update_no.do" method="post">
				...
				<table class="table table-striped">
					...
					<tr>
						<td>제목</td>
						<td><input type="text" name="subject" required="required" value="${tboard_no.subject}"></td>
					</tr>
					<tr>
						<td>내용</td>
						<td><textarea rows="5" cols="30" name="content" required="required">${tboard_no.content}</textarea></td>
					</tr>
					<tr>
