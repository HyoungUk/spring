	...
	<div id="container">
		...
		<div class="container" align="center">
			...
			<c:if test="${result==0}">
				...
				<p>댓글을 작성하시려면 로그인을 해주세요
			</c:if>

			<c:if test="${result==1}">
				<a class="btn btn-info" href="freeBoardList.do?pageNum=${pageNum}">목록</a>
				<a class="btn btn-info"
					href="insertForm.do?nm=${tboard.t_num}&pageNum=${pageNum}">답글</a>
			...
			<c:if test="${result==2}">
				...
				<a class="btn btn-warning"
					href="updateForm.do?num=${tboard.t_num}&pageNum=${pageNum}">수정</a>
				<a class="btn btn-info"
					href="delete.do?num=${tboard.t_num}&pageNum=${pageNum}">삭제</a>
				<form name="frm" id="frm">
					<input type="hidden" name="tno" value="${tboard.t_num}">
					댓글:
					<textarea rows="3" cols="50" name="replytext"></textarea>
